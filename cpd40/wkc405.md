...
- [ ] 3.0  OpenShift Cluster and Node settings
- [ ] 4.0  Configuring cluster pull images
- [ ] 5.0  Project creation and NamespaceScope
- [ ] 6.0  Custom Security Context Constraints
- [ ] 7.0  Create IBM Operator Catalog source
- [ ] 8.0  Installing IBM Cloud Pak foundation services
- [ ] 9.0  Create IBM Operator Subscription
- [ ] 10.0 Installing Cloud Pak for Data platform
...
***
#### 5.0 Project Creation for Cloud Pak for Data
***
...
***
#### 6.0 Install IBM Cloud Pak Foundational Services
***
...
***
#### 7.0 Creating Operator Subscriptions
***
...
***
#### 8.0 Creating the custom security context constraint for Watson Knowledge Catalog
***
...
***
#### 9.0 Installation of Cloud Pak for Data
***
